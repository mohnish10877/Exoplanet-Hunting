...
test_data = pd.read_csv('D:\Downloads\kepler-labelled-time-series-data\exoTest.csv')

train_data = pd.read_csv('D:\Downloads\kepler-labelled-time-series-data\exoTrain.csv')
